...
#######################################
		...
		if ($local1UseBaseTenLogHelp == 1 || $local2UseBaseTenLogHelp == 1 || $globalUseBaseTenLogHelp == 1) {
			$useBaseTenLogHelpString =
				"<li><font color='#222255'>Entering logarithms:</font> <blockquote>In this question, use <code>ln(x)</code> for natural log, and <code>log(x), logten(x)</code> or <code>log10(x)</code> for the base 10 logarithm.  Enter log base b as <code>ln(x)/ln(b)</code></blockquote><br /></li>";
		} else {
			$useBaseTenLogHelpString =
				"<li><font color='#222255'>Entering logarithms:</font> <blockquote><font color='#ff0000'><b>Caution:</b></font> In this question, use <code>ln(x)</code> or <code>log(x)</code> for natural log, and <code>logten(x)</code> or <code>log10(x)</code> for the base 10 logarithm.  Enter log base b as <code>ln(x)/ln(b)</code></blockquote><br /></li>";
		}
...
###############################################
		...
		if ($local1UseBaseTenLogHelp == 1 || $local2UseBaseTenLogHelp == 1 || $globalUseBaseTenLogHelp == 1) {
			...
			$naturalLogHelpString =
				"<li><font color='#FF0000'><b>Caution:</b></font> In this question <b><code>log(x)</code></b> is the same as <b><code>ln(x)</code></b><br /><br /></li><li><font color='#222255'>Entering natural logarithm:</font> In this question, use <code>ln(x)</code> or <code>log(x)</code><br /><br /></li>";
			$basetenLogHelpString =
