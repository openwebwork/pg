...
# use Renderer::Utils qw(path_is_subdir);
...
Renderer::IO - Private functions used by Renderer::Translator for file IO.
...
BEGIN {
	...
	if (defined $ww_version) {
		...
		for ($ww_version) {
			...
			/^2\./          and $mod = "Renderer::IO::WW2";
			/^Daemon\s*2\./ and $mod = "Renderer::IO::Daemon2";
		}
...
=head1 SYNOPSIS
 ...
 use Renderer::IO;
 my %functions_to_share = %Renderer::IO::SHARE;
...
This module also maintains a hash C<%Renderer::IO::SHARE>. The keys of this
...
# This is needed for the subroutine below.  It is copied from Renderer::Utils.
