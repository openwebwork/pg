...
$PG::Constants::PG_DIRECTORY = $ENV{PG_ROOT} unless defined($PG::Constants::PG_DIRECTORY);
...
#
$PG::Debug::Logfile = $PG::Constants::PG_DIRECTORY . "/logs/debug.log";
...
#
$PG::Debug::DenySubroutineOutput = undef;
#$WeBWorK::Debug::DenySubroutineOutput = qr/^WeBWorK::dispatch$/;
...
#
$PG::ContentGenerator::Hardcopy::PreserveTempFiles = 0;
...
#     $Renderer::ImageGenerator::DvipngArgs = "-x4000.5 -bgTransparent -Q6 -mode toshiba -D180";
# For dvipng versions 1.0 to 1.5
#     $Renderer::ImageGenerator::DvipngArgs = "-bgTransparent -D120 -q -depth";
#
...
#
$PG::Renderer::ImageGenerator::DvipngArgs = "-bgTransparent -D120 -q -depth";

# If true, don't delete temporary files
#
$PG::Renderer::ImageGenerator::PreserveTempFiles = 0;
# TeX to prepend to equations to be processed.
#
$PG::Renderer::ImageGenerator::TexPreamble = <<'EOF';
...
#
$PG::Renderer::ImageGenerator::TexPostamble = <<'EOF';
\end{document}
EOF
