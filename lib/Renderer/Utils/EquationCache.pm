...
package Renderer::Utils::EquationCache;

=head1 NAME

Renderer::Utils::EquationCache - create and cache images of TeX equations.

=head1 SYNPOSIS

 my $cache = Renderer::Utils::EquationCache->new(cacheDB => "/path/to/equationcache.db");
