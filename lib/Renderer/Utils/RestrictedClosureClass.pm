...
package Renderer::Utils::RestrictedClosureClass;

=head1 NAME

Renderer::Utils::RestrictedClosureClass - Protect instance data and only allow
...
=head1 SYNPOSIS
 ...
 my $locked = new Renderer::Utils::RestrictedClosureClass($obj, qw/use_secret call_for_help/);
